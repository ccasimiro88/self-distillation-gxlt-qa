""" Slightly adapted version from official evaluation script for v1.1 of the SQuAD dataset. """
...
def evaluate(dataset, predictions, context_lang, question_lang, dataset_type):
    ...
    f1 = 100.0 * f1 / total
    eval_report = {'testset': dataset_type, 'context_lang': context_lang, 'question_lang': question_lang,
...
if __name__ == '__main__':
    ...
    with open(args.results_file, "a") as fn:
        fn.write(str(evaluate(dataset, predictions, args.context_language, args.question_language, args.dataset_type))+"\n")